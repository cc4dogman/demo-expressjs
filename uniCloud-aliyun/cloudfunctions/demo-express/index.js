...
var http__default$1 = /*#__PURE__*/_interopDefaultLegacy(http);
var url__default$1 = /*#__PURE__*/_interopDefaultLegacy(url);
var path__default$1 = /*#__PURE__*/_interopDefaultLegacy(path$2);
...
var http__default = /*#__PURE__*/_interopDefaultLegacy$1(http__default$1['default']);
var url__default = /*#__PURE__*/_interopDefaultLegacy$1(url__default$1['default']);
...
function isContentTypeBinaryMimeType(params) {
  return (
    ...
    !!typeIs.is(params.contentType, params.binaryMimeTypes)
  );
}
        ...
        if (Array.isArray(headers[h])) {
          if (h.toLowerCase() === "set-cookie") {
            headers[h].forEach((value, i) => {
              headers[binaryCase_1(h, i + 1)] = value;
            });
            delete headers[h];
          } else {
...
function forwardRequestToNodeServer(server, event, context, resolver) {
  try {
    ...
    const req = http__default['default'].request(requestOptions, (response) =>
...
function createServer(requestListener, serverListenCallback, binaryTypes) {
  const server = http__default['default'].createServer(requestListener);
...
var createServer_1 = createServer;
var proxy_1 = proxy;

var unicloudExpress = {
	createServer: createServer_1,
	proxy: proxy_1
};

var uniCloudExpressjs = unicloudExpress;

var dist = uniCloudExpressjs;
...
var compat = createCommonjsModule$1(function (module) {
...
var relative = path__default$1['default'].relative;
...
var codes$2 = getCjsExportFromNamespace$1(codes$1);
...
var httpErrors = createCommonjsModule$1(function (module) {
...
var httpErrors$1 = createCommonjsModule$1(function (module) {
...
var httpErrors$2 = createCommonjsModule$1(function (module) {
...
var require$$0$1 = getCjsExportFromNamespace$1(shiftjis$1);

var require$$1 = getCjsExportFromNamespace$1(eucjp$1);

var require$$2 = getCjsExportFromNamespace$1(cp936$1);

var require$$3 = getCjsExportFromNamespace$1(gbkAdded$1);

var require$$4 = getCjsExportFromNamespace$1(gb18030Ranges$1);

var require$$5 = getCjsExportFromNamespace$1(cp949$1);

var require$$6 = getCjsExportFromNamespace$1(cp950$1);

var require$$7 = getCjsExportFromNamespace$1(big5Added$1);
...
function getDecoder (encoding) {
  ...
  try {
    ...
    throw httpErrors$2(415, 'specified encoding unsupported', {
      encoding: encoding,
...
function readStream (stream, encoding, length, limit, callback) {
  ...
  if (limit !== null && length !== null && length > limit) {
    return done(httpErrors$2(413, 'request entity too large', {
      expected: length,
      length: length,
      limit: limit,
  ...
  if (stream._decoder || (state && (state.encoding || state.decoder))) {
    // developer error
    return done(httpErrors$2(500, 'stream encoding should not be set', {
  ...
  function onAborted () {
    ...
    done(httpErrors$2(400, 'request aborted', {
      code: 'ECONNABORTED',
      expected: length,
      length: length,
      received: received,
  ...
  function onData (chunk) {
    ...
    if (limit !== null && received > limit) {
      done(httpErrors$2(413, 'request entity too large', {
        limit: limit,
        received: received,
        type: 'entity.too.large'
      }));
  ...
  function onEnd (err) {
    ...
    if (length !== null && received !== length) {
      done(httpErrors$2(400, 'request size did not match content length', {
        expected: length,
        length: length,
        received: received,
 ...
 * OCTET         = <any 8-bit sequence of data>
 */
var paramRegExp$1 = /; *([!#$%&'\*\+\-\.0-9A-Z\^_`a-z\|~]+) *= *("(?:[ !\u0023-\u005b\u005d-\u007e\u0080-\u00ff]|\\[\u0020-\u007e])*"|[!#$%&'\*\+\-\.0-9A-Z\^_`a-z\|~]+) */g;
var textRegExp$1 = /^[\u0020-\u007e\u0080-\u00ff]+$/;
var tokenRegExp$1 = /^[!#$%&'\*\+\-\.0-9A-Z\^_`a-z\|~]+$/;
 ...
 * DIGIT =  %x30-39             ; 0-9
 */
var subtypeNameRegExp$1 = /^[A-Za-z0-9][A-Za-z0-9!#$&^_.-]{0,126}$/;
var typeNameRegExp$1 = /^[A-Za-z0-9][A-Za-z0-9!#$&^_-]{0,126}$/;
var typeRegExp$1 = /^ *([A-Za-z0-9][A-Za-z0-9!#$&^_-]{0,126})\/([A-Za-z0-9][A-Za-z0-9!#$&^_.+-]{0,126}) *$/;
...
function format$3(obj) {
  ...
  if (!type || !typeNameRegExp$1.test(type)) {
    throw new TypeError('invalid type')
  }

  if (!subtype || !subtypeNameRegExp$1.test(subtype)) {
    throw new TypeError('invalid subtype')
  }
  ...
  // append +suffix
  if (suffix) {
    if (!typeNameRegExp$1.test(suffix)) {
      throw new TypeError('invalid suffix')
    }
...
function parse$4(string) {
  ...
  // support req/res-like objects as argument
  if (typeof string === 'object') {
    string = getcontenttype$2(string);
  }
  ...
  var key;
  var match;
  var obj = splitType$1(type);
  var params = {};
  var value;

  paramRegExp$1.lastIndex = index;

  while (match = paramRegExp$1.exec(string)) {
    if (match.index !== index) {
      throw new TypeError('invalid parameter format')
    }
...
function qstring$2(val) {
  ...
  // no need to quote tokens
  if (tokenRegExp$1.test(str)) {
    return str
  }

  if (str.length > 0 && !textRegExp$1.test(str)) {
    throw new TypeError('invalid parameter value')
  }

  return '"' + str.replace(quoteRegExp$1, '\\$1') + '"'
}
...
function splitType$1(string) {
  var match = typeRegExp$1.exec(string.toLowerCase());
...
var db$3 = /*#__PURE__*/Object.freeze({
	__proto__: null,
	'default': db$2
});

var require$$0$2 = getCjsExportFromNamespace$1(db$3);
...
var mimeTypes$1 = createCommonjsModule$1(function (module, exports) {
...
var extname = path__default$1['default'].extname;
...
function charset (type) {
  ...
  // TODO: use media-typer
  var match = EXTRACT_TYPE_REGEXP.exec(type);
  var mime = match && mimeDb$1[match[1].toLowerCase()];
...
function populateMaps (extensions, types) {
  ...
  Object.keys(mimeDb$1).forEach(function forEachMimeType (type) {
    var mime = mimeDb$1[type];
    var exts = mime.extensions;
    ...
    for (var i = 0; i < exts.length; i++) {
      ...
      if (types[extension]) {
        var from = preference.indexOf(mimeDb$1[types[extension]].source);
        var to = preference.indexOf(mime.source);
...
var mimeTypes_1$1 = mimeTypes$1.charset;
var mimeTypes_2$1 = mimeTypes$1.charsets;
var mimeTypes_3$1 = mimeTypes$1.contentType;
var mimeTypes_4$1 = mimeTypes$1.extension;
var mimeTypes_5$1 = mimeTypes$1.extensions;
var mimeTypes_6$1 = mimeTypes$1.lookup;
var mimeTypes_7$1 = mimeTypes$1.types;
...
var typeIs$1 = typeofrequest$1;
var is$1 = typeis$1;
var hasBody$1 = hasbody$1;
var normalize_1$1 = normalize$1;
var match$1 = mimeMatch$1;
...
function typeis$1 (value, types_) {
  ...
  // remove parameters and normalize
  var val = tryNormalizeType$1(value);
  ...
  var type;
  for (i = 0; i < types.length; i++) {
    if (mimeMatch$1(normalize$1(type = types[i]), val)) {
      return type[0] === '+' || type.indexOf('*') !== -1
        ? val
        : type
    }
...
function typeofrequest$1 (req, types_) {
  var types = types_;
...
function mimeMatch$1 (expected, actual) {
  // invalid type
  if (expected === false) {
    return false
  }
...
function normalizeType$1 (value) {
  // parse the type
  var type = mediaTyper$1.parse(value);

  // remove the parameters
  type.parameters = undefined;

  // reformat it
  return mediaTyper$1.format(type)
}
...
function tryNormalizeType$1 (value) {
  if (!value) {
    return null
  }
...
typeIs$1.is = is$1;
typeIs$1.hasBody = hasBody$1;
typeIs$1.normalize = normalize_1$1;
typeIs$1.match = match$1;
...
var bodyParser_1 = createCommonjsModule$1(function (module, exports) {
...
var parse$6 = url__default$1['default'].parse;
var Url = url__default$1['default'].Url;
...
function getCurrentNodeMethods() {
  return http__default$1['default'].METHODS && http__default$1['default'].METHODS.map(function lowerCaseMethod(method) {
...
var utilsMerge = createCommonjsModule$1(function (module, exports) {
/**
...
var router = createCommonjsModule$1(function (module) {
...
var path = path__default$1['default'];
...
var basename$1 = path__default$1['default'].basename;
...
var require$$0$3 = getCjsExportFromNamespace$1(types$1);
...
var path$1 = path__default$1['default'];
...
var normalize$2 = path$1.normalize;
...
SendStream.prototype.pipe = function pipe (res) {
  ...
  if (root !== null) {
    ...
    path = normalize$2(join$1(root, path));
  } else {
    ...
    // explode path parts
    parts = normalize$2(path).split(sep);
...
var ipaddr = createCommonjsModule$1(function (module) {
(function() {
...
var application = createCommonjsModule$1(function (module, exports) {
...
app.listen = function listen() {
  var server = http__default$1['default'].createServer(this);
...
var req = Object.create(http__default$1['default'].IncomingMessage.prototype);
...
var cookieSignature = createCommonjsModule$1(function (module, exports) {
/**
 * Module dependencies.
 */
...
var normalizeType$2 = utils$1.normalizeType;
var normalizeTypes = utils$1.normalizeTypes;
var setCharset = utils$1.setCharset;


var extname$2 = path__default$1['default'].extname;
var mime$1 = send_1.mime;
var resolve$2 = path__default$1['default'].resolve;
...
var res = Object.create(http__default$1['default'].ServerResponse.prototype);
...
res.format = function(obj){
  ...
  if (key) {
    this.set('Content-Type', normalizeType$2(key).value);
...
var resolve$3 = path__default$1['default'].resolve;
...
function createRedirectDirectoryListener () {
  return function redirect (res) {
    ...
    // reformat the URL
    var loc = encodeurl(url__default$1['default'].format(originalUrl));
...
var express = createCommonjsModule$1(function (module, exports) {
...
/* GET home page. */
router$1.get("/", function (req, res, next) {
...
const collection = db$4.collection("unicloud-test");
class UniDBService {
  async add(event) {
...
var UniDBService_1 = new UniDBService();

var router$2 = express$1.Router();


/* GET home page. */
router$2.post("/add", async (req, res, next) => {
  try {
    console.log(req.body);
    const result = await UniDBService_1.add(req.body);
    res.json(result);
  } catch (e) {
    next(e);
  }
...
router$2.post("/update", async (req, res, next) => {
  try {
    const result = await UniDBService_1.update(req.body);
    res.json(result);
  } catch (e) {
    next(e);
  }
...
router$2.get("/get", async (req, res, next) => {
  try {
    const result = await UniDBService_1.get(req.query);
    res.json(result);
  } catch (e) {
    next(e);
  }
...
router$2.get("/remove", async (req, res, next) => {
  try {
    const result = await UniDBService_1.remove(req.query);
    res.json(result);
  } catch (e) {
    next(e);
  }
...
const server = dist.createServer(app_1);
var main = async (event, context) => {
  //event为客户端上传的参数
  console.log("event : ", event);
  //返回数据给客户端
  try {
    let result = await dist.proxy(server, event, context);
    return result;
  } catch (err) {
    console.error(err);
    return {
